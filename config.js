...
OWNER_NUMBER: process.env.OWNER_NUMBER || "256787038917", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "Malakz Emmy", // Input Yours custom...(Maintain font for Flow)
...
ANTICALL_MSG: process.env.ANTICALL_MSG || "*_🚨 This is a NO-CALL ZONE 🚨
Violators will be ignored without warning 😄
Kindly text.*",
